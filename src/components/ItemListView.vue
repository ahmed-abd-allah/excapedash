  ...
  <vx-card class="list-view-item overflow-hidden" v-on="$listeners">
    <template slot="no-body">
      <div class="vx-row item-details no-gutter">
        ...
        >
          <img v-if="item.image" :src="item.image" :alt="item.name" class="grid-view-img px-12" />
          <img
            v-else
          ...
          <div class="p-4 pt-6">
            <slot name="item-meta">
              ...
              <p class="text-sm mb-4">
                By
                <span class="font-semibold cursor-pointer">{{ item.brand }}</span>
              </p>
              <p class="item-description text-sm">{{ item.desc }}</p>
            </slot>
          </div>
        </div>
        ...
        >
          <div class="p-4 flex flex-col w-full">
            ...
            <div class="my-6">
              <h5 class="font-bold text-center">${{ item.totalPrice *q}}</h5>
              <span
